...
## makeCacheMatrix create a matrix object that caches its inverse. 
## cacheSolve checks to see whether the inverse of of makeCache Matrix has already been calculated. 
## If it has, it pulls from the cache. If not, it calculates.
...
makeCacheMatrix <- function(x = matrix()) {
    ...
    list(set = set, get = get, setinverse = setinverse, getinverse = getinverse)  ## This is needed in order to refer to the functions with the $ operator
